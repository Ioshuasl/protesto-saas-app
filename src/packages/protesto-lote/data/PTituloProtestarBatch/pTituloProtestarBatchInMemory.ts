...
function mapBatchTitulosFromDb(): PTituloProtestarBatchInterface[] {
  ...
  return titulos.map((titulo) => {
    ...
    return {
      ...
      data_protesto: titulo.data_protesto,
...
export const pTituloProtestarBatchListRef: { current: PTituloProtestarBatchInterface[] } = {
