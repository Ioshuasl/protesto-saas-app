...
export default function TipoDaParteSelect({ field }: TipoDaParteSelectProps) {
  const [open, setOpen] = React.useState(false);

  // Cria as opções a partir do enum
  const options = Object.entries(TipoDaParteEnum).map(([key, label]) => ({
    value: Number(key),
    label,
  }));
